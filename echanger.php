...
<html>
    ...
    <body>
        ...
        <div id="echanger">
            ...
            <form id="formuinscription" method="post" action="postannonceechange.php">
...
<input type="radio" name="fruits1" value="non" id="fruitslegumes" /> <label for="fruitslegumes">Fruits et légumes</label>
     ...
     <fieldset>
      ...
      <legend>Détail de ce que vous recherchez</legend>
         ...
         <p><label for="legumesrecherches">Légumes recherchés*  : </label>
         <select name="legumesrecherches">
    <option value="choix1">Choix 1</option>
    <option value="choix2">Choix 2</option>
    <option value="choix3">Choix 3</option>
    <option value="choix4">Choix 4</option>
         ...
         <p><label for="fruitsrecherches">Fruits recherchés*  : </label>
         <select name="fruitsrecherches">
    <option value="choix1">Choix 1</option>
    <option value="choix2">Choix 2</option>
    <option value="choix3">Choix 3</option>
    <option value="choix4">Choix 4</option>
